...
│       ├── include/            # x86 Linux 端口公共头（lv_port_disp.h / lv_port_indev.h）
│       └── src/
│           └── porting/        # SDL monitor + 鼠标/键盘/滚轮 + x86 lv_conf/lv_drv_conf
│
└── src/                        # 源代码
    ├── main.c                  # 入口，初始化与主循环
...
| 项目 | 参考内容 |
|------|---------|
| [M5Claw](https://github.com/fwz233-RE/M5Claw) | Agent 架构、记忆系统、工具注册模式（C++ / ESP32） |
| [MimiClaw](https://github.com/memovai/mimiclaw) | 消息总线、通道抽象、技能系统（C / ESP-IDF） |
| [小智-KelpBar海带Linux智慧屏项目](https://x509p6c8to.feishu.cn/docx/R9XudhDAfo2Qx5xZAzpchMkqnCg) | T113 交叉编译配置、预编译 ARM 库 |
| [扩展-智慧屏小智Linux AI助手](https://x509p6c8to.feishu.cn/docx/GDD5dhbCXoAPrFxekSgco6Jtneg) | OpenSSL 头文件、音频处理参考 |
